...
from training_environment.agent_wrappers.bidding_wrapper import BiddingWrapper
...
class C51BiddingWrapper(BiddingWrapper):
    ...
    def __init__(self, player_name, train_bidding_env, eval_bidding_env, c51_config: C51Config, game_config: GameConfig,
                 agent_mode, directory,
