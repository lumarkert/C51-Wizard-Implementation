...
class TFWizardPlayEnv(py_environment.PyEnvironment):
    ...
    def determine_observation_spec_full_ohe(self, game_config: GameConfig):
        ...
        number_of_inputs = 3 * self.number_of_cards + (2 * game_config.number_of_total_rounds) + (2 * (game_config.number_of_total_rounds + 1)) + (game_config.number_of_colors + 1) + game_config.num_players + (2 * ((game_config.num_players - 1) * (game_config.number_of_total_rounds + 1)))
