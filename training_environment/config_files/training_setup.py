...
from training_environment.config_files.rl_config import RLConfig
from training_environment.config_files.training_config import TrainingConfig
...
class TrainingSetup:
    ...
    def load_setup_from_file(self, file_name):
        ...
        new_dir = os.path.join(current_dir, "training_environment/pre_configs/setup")
